...
int main(int argc, char *argv[]) {
    ...
    gtk_window_set_default_size(GTK_WINDOW(starting_window), 300, 500);
    // gtk_window_set_position(GTK_WINDOW(window),GTK_WIN_POS_CENTER);
    gtk_container_set_border_width(GTK_CONTAINER(starting_window), 20);
    ...
    gtk_fixed_put(GTK_FIXED(fixed), start_button, 70, 205);
