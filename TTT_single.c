...
void activate(GtkApplication *app, gpointer user_data) {
    ...
    // X Scoreboard
    GtkWidget *score_x_label = gtk_label_new("X (CPU)\n       0");
    ...
    // O Scoreboard
    GtkWidget *score_o_label = gtk_label_new("O (YOU)\n        0");
